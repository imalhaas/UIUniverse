<script>
    ...
    const items = [
    {tittle: 'Item 1', category: 'Componentes', image:'' }
    ]
</script>
...
<section class="bg-white dark:bg-gray-900">
    <div class="container mx-auto">
        ...
        <section class="mt-8 space-y-8 lg:mt-12">
            ...
            {#each items as {tittle, category, image} }
        <section class="lg:flex lg:items-center">
            <div class="lg:w-1/2 ">
                ...
                <h2 class="mt-2 text-2xl font-semibold text-gray-800 capitalize dark:text-white">{tittle}</h2>
            </div>
