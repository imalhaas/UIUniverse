...
<section class="bg-white dark:bg-gray-900">
    <div class="container px-6 py-12 mx-auto">
        <div>
            ...
            <h1 class="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">Minha vida perfeita </h1>

            <p class="mt-3 text-gray-500 dark:text-gray-400">Te amo minha vida</p>
        </div>
